...
const MatchGeneralInfo = () => {
  return (
    <div className="container card-css">
      <section className="intersection-wrapper">
          ...
          <div className="grid-container">
            ...
            <div className="middle-grid-item">
              <a className="header-league-css">
                ...
                <span className="league-name">Super Lig</span>
                <span>Round 13</span>
              </a>
            </div>
                ...
                <a>
                  <div className="team-markup-apply-hover">
                    ...
                    <img
                      ...
                      width="50"
                      height="50"
                      src="https://images.fotmob.com/image_resources/logo/teamlogo/8695_small.png"
                    />
                  </div>
                </a>
                <div className="css-match-info-wrapper">
                  <span className="css-match-info-topRow">1 - 0</span>
                  <span className="css-match-info-bottomRow">Full-Time</span>
                </div>
                <a>
                  <div className="team-markup-apply-hover1">
                    <img
                      ...
                      width="50"
                      height="50"
                      src="https://images.fotmob.com/image_resources/logo/teamlogo/6265_small.png"
                    />
                    <span className="teamName">
                      <span>Sivasspor</span>
                    </span>
          ...
          <div className="goal-container-apply-hover">
            <ul>
              <li>
                <a>
                  <span>Valencia</span>
                  <span className="event-time">55' (Pen)</span>
                </a>
              </li>
            </ul>
            <ul></ul>
            ...
            <section className="info-box-wrapper-applyHover">
              <ul className="info-box-data">
                <li className="info-box-item">
                  ...
                  <time dateTime="2022-11-07T17:00:00.000Z">
                    <span>Mon, Nov 7 2022</span>,
                  </time>
                  &nbsp;
                  <time dateTime="20:00">
                    <span> 20:00</span>
                ...
                <li className="info-box-item">
                  ...
                  >
                    ...
                    <span>Ülker Stadyumu Fenerbahçe Şükrü Saracoğl</span>
                  </a>
                </li>
                <li className="info-box-item">
                  <svg
